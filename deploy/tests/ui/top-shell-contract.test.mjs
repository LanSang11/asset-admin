...
test('portal、守卫、路由、权限与 KeepAlive 真值文件保持实施前哈希', () => {
  const expected = {
    'web/src/utils/portal.js': 'F4E17352BBA1C1CECE21F769935D6F50CDE73DC956DD6F260D2BA5DCA6ABBE10',
    'web/src/router/guard/auth-guard.js': '242CCBB951C674B62C06C99AC473005137FA9FCD67DB3DB957B12F35BE2A0F07',
    'web/src/router/routes/index.js': '33BCB57FBCDABEE68E858D3225C8C3D9A908A9A37DDA498927E3D7068FF59E6F',
